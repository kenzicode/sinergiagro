 ...
 *
 * Be sure to replace all instances of 'kr_' with your project's prefix.
 ...
 */
function kr_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function kr_hide_if_no_cats( $field ) {
 ...
 */
function kr_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function kr_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function kr_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'kr_register_product_variant' );

function kr_register_product_variant() {
    $variant_box = new_cmb2_box( array(
        'id'        => 'variant_box',
        'title'     => esc_html__('Add Product Variant'),
        'object_types'  => array('product', 'productvariant')
    ));

    $variant_box->add_field( array(
	...
	$variant_box->add_field( array(
		'name' => esc_html__( 'Document', 'cmb2' ),
		'desc' => esc_html__( 'Upload document related to product.', 'cmb2' ),
		'id'   => 'variant_document',
		'type' => 'file_list',
		'query_args' => array(
    ...
    $variant_group = $variant_box->add_field( array(
        'id'        => 'variant_group',
        'type'      => 'group',
        'options'     => array(
			'group_title'    => esc_html__( 'Variant {#}', 'cmb2' ), // {#} gets replaced by row number
    ...
    $variant_box->add_group_field( $variant_group, array(
        'name'      => esc_html__( 'Title', 'cmb2' ),
        'id'        => 'variant_title',
        'type'      => 'text',
    ));
...
// add_action( 'cmb2_admin_init', 'kr_register_productpage_variant' );

// function kr_register_productpage_variant() {
//     $productvariant_box = new_cmb2_box( array(
//         'id'        => 'prodvariant_box',
//         'title'     => esc_html__('Add Product Variant'),
...
//     $productvariant_box->add_field( array(
//         'name'       => __( 'Select Product Variant', 'cmb2' ),
//         'desc'       => __( '', 'cmb2' ),
//         'id'         => '_product_variant',
//         'type'       => 'multicheck',
//         'options_cb' => 'cmb2_get_productvariant_options',
//     ) );
...
// add_action( 'cmb2_admin_init', 'kr_register_product_table_metabox');

// function kr_register_product_table_metabox() {
//     $table_group = new_cmb2_box( array(
//         'id'            => 'kr_table_metabox',
//         'title'         => esc_html__('Product Variant'),
//         'object_types'  => array('product'),
//         'show_on'       => array( 'key' => 'page-template', 'value' => 'page-productwithtable.php' ),
//     ));

//     	// $group_field_id is the field id string, so in this case: 'kr_group_demo'
// 	$table_group_id = $table_group->add_field( array(
// 		'id'          => 'table_group_id',
// 		'type'        => 'group',
// 		'description' => esc_html__( 'Add Product Specification', 'cmb2' ),
// 		'options'     => array(
// 			'group_title'    => esc_html__( 'Variant {#}', 'cmb2' ), // {#} gets replaced by row number
// 			'add_button'     => esc_html__( 'Add Another Entry', 'cmb2' ),
// 			'remove_button'  => esc_html__( 'Remove Entry', 'cmb2' ),
...
//     $table_group->add_group_field( $table_group_id, array(
...
//     $table_group->add_group_field( $table_group_id, array(
// 		'name'       => esc_html__( 'Size & Length', 'cmb2' ),
// 		'id'         => 'size',
// 		'type'       => 'text',
//         'default'    => '--',
// 		// 'repeatable' => true, // Repeatable fields are supported w/in repeatable groups (for most types)
...
//     $table_group->add_group_field( $table_group_id, array(
// 		'name'       => esc_html__( 'Admixture', 'cmb2' ),
// 		'id'         => 'admixture',
// 		'type'       => 'text',
//         'default'    => '--',
// 		// 'repeatable' => true, // Repeatable fields are supported w/in repeatable groups (for most types)
...
// add_action( 'cmb2_admin_init', 'kr_register_demo_metabox' );
// /**
//  * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
//  */
// function kr_register_demo_metabox() {
// 	/**
...
// 		// 'show_on_cb' => 'kr_show_if_front_page', // function should return a bool value
// 		// 'context'    => 'normal',
// 		// 'priority'   => 'high',
...
// 		// 'classes_cb' => 'kr_add_some_classes', // Add classes through a callback.
...
// 		'id'         => 'kr_demo_text',
// 		'type'       => 'text',
// 		'show_on_cb' => 'kr_hide_if_no_cats', // function should return a bool value
...
// 		// );
// 		// 'display_cb' => 'kr_display_text_small_column', // Output the display of the column values through a callback.
// 	) );

// 	$cmb_demo->add_field( array(
// 		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
// 		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
// 		'id'   => 'kr_demo_textmedium',
// 		'type' => 'text_medium',
// 	) );
...
// 		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
// 		'id'   => 'kr_demo_render_row_cb',
// 		'type' => 'text',
// 		'render_row_cb' => 'kr_render_row_cb',
// 	) );
...
// 		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
// 		'id'   => 'kr_demo_textdate_timestamp',
// 		'type' => 'text_date_timestamp',
// 		// 'timezone_meta_key' => 'kr_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
// 	) );

// 	$cmb_demo->add_field( array(
// 		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
// 		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
// 		'id'   => 'kr_demo_datetime_timestamp',
...
// 	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
// 	// 	'id'   => 'kr_demo_datetime_timestamp_timezone',
...
// 		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
// 		'id'       => 'kr_demo_text_taxonomy_radio',
...
// 		'id'           => 'kr_demo_parameters',
// 		'type'         => 'text',
// 		'before_row'   => 'kr_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'kr_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function kr_register_about_page_metabox() {
...
add_action( 'cmb2_admin_init', 'kr_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function kr_register_repeatable_group_field_metabox() {
...
add_action( 'cmb2_admin_init', 'kr_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function kr_register_user_profile_metabox() {
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'kr_user_user_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'kr_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function kr_register_taxonomy_metabox() {
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'kr_term_term_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'kr_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function kr_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'kr_theme_options_page',
		...
		'option_key'      => 'kr_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'kr_options_page_message_callback',
 ...
 * }
 */
function kr_options_page_message_callback( $cmb, $args ) {
 ...
 */
function kr_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'kr_register_rest_api_box' );
/**
 ...
 */
function kr_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'kr_limit_rest_view_to_logged_in_users',
	) );
